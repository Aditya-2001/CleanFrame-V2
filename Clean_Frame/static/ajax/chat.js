...
function add_message_mine(message){
    ...
    if(image==0)
        message='<div class="alert container alert-success" role="alert"> <img src="/static/home/images/user.png" alt="Avatar" class="right" style="width: 50px; height: 50px;"><p>'+message+'</p><span class="time-left">'+username+' , '+ time+'</span></div>'
    else{
        base_url="/media/"
        next_url=image
        message=`
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(data!=0){
                ...
                document.getElementById("total_new_messages").innerHTML=total_new_messages
                for(var i=0;i<n;i++){
